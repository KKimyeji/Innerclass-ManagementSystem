...
public class OldageclassInnerclass extends Innerclass implements Input {
	...
	public void printInfo() {
		...
		System.out.println("kind:" + skind + "classname:" + classname + "classplace:" + classplace + "classID:"
				+ classID + "calsstime:" + classTime + "OtherStudentclassID:" + classID + "OtherStudentcalsstime:"
				+ classTime);
	}
